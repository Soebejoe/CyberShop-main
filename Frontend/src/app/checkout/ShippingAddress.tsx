        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3">
            <div>
              ...
              <Input className="mt-1.5" defaultValue="Firman" />
            </div>
            <div>
              <Label className="text-sm">Last name</Label>
              <Input className="mt-1.5" defaultValue="Aulia Wahid " />
            </div>
          </div>
          ...
          <div className="sm:flex space-y-4 sm:space-y-0 sm:space-x-3">
            <div className="flex-1">
              ...
              <Input
                className="mt-1.5"
                placeholder=""
                defaultValue={"123, Jl Soekarno, IDN"}
                type={"text"}
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3">
            <div>
              ...
              <Input className="mt-1.5" defaultValue="Batu" />
            </div>
            <div>
              <Label className="text-sm">Country</Label>
              <Select className="mt-1.5" defaultValue="Indonesia ">
                <option value="Indonesia">Indonesia</option>
                <option value="Indonesia">Canada</option>
                <option value="Indonesia">Mexico</option>
                <option value="Indonesia">Israel</option>
                <option value="Indonesia">France</option>
                <option value="Indonesia">England</option>
                <option value="Indonesia">Laos</option>
                <option value="Indonesia">China</option>
              </Select>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-3">
            <div>
              ...
              <Input className="mt-1.5" defaultValue="Jawa Timur" />
            </div>
            <div>
